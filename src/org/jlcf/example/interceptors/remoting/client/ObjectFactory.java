 ...
 * org.jlcf.example.interceptors.remoting.client package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _SayHello_QNAME = new QName(
			"http://remoting.interceptors.example.jlcf.org/", "sayHello");
	 ...
	 * org.jlcf.example.interceptors.remoting.client
	 * 
	 */
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://remoting.interceptors.example.jlcf.org/", name = "sayHello")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://remoting.interceptors.example.jlcf.org/", name = "sayHelloResponse")
